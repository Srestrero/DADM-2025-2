...
public class MenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button buttonOnlineGame = findViewById(R.id.button_online_game);
        ...
        buttonOnlineGame.setOnClickListener(v -> startOnlineGame());
    ...
    private void startOnlineGame() {
        // Ir directamente a la configuración del servidor para el modo online
